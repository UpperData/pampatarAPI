...
router.get('/geneRals/GetTAx/byTyPE/:taxTypeId',authorization.requireRole([{"id":5},{"id":6},{"id":7}]),generals.getTaxByType);
router.get('/generAls/Get/TAXType/',authorization.requireRole([{"id":5},{"id":6},{"id":7}]),generals.getTaxType);
