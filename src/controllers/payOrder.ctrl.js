...
async function sendEmail(data){
    ...
    /*mailsend = mail.sendEmail({
        ...
        res.json({ "data": { "result": true, "message": "Su compra se a procesado satisfactoriamente" } })
    }).catch(async function (erro){
        
        res.json({ "data": { "result": false, "message": "Algo salió mal tratando de enviar notificación a Correo Electrónico" } })
    })*/
}
module.exports={
